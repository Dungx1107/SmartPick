...
//                Log.d("credential_DEBUG", "Đã lấy được Token: ${credential.idToken}")
//                onTokenReceived(credential.idToken)
//            } else {
//                Log.e("credential_DEBUG", "Nhận được loại credential lạ: ${credential.type}")
//            }
            // ko dùng "is", dùng cách chính thống của thư viện Google ID
